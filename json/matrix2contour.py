...
parser = argparse.ArgumentParser(description='Convert from numpy matrix to geojson contour.')
parser.add_argument('--input', metavar='i', type=str, nargs='1',
                    help='an input file with a numpy matrix preceded by a key and a \\t.')
